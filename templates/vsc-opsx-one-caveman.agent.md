---
name: VSC OPSX One Caveman
description: Spec-driven development — intake to archive in one session — caveman-speak output (~75% fewer tokens) (VS Code Copilot Chat)
