---
name: VSC OPSX Designer One Caveman
description: Design-first implementation loop, then OpenSpec artifacts + verification — caveman-speak output (~75% fewer tokens) (VS Code Copilot Chat)
