---
name: VSC OPSX One Retrofit Caveman
description: Existing-project retrofit agent for deep audit, OpenSpec config generation, and readiness setup — caveman-speak output (~75% fewer tokens) (VS Code Copilot Chat)
